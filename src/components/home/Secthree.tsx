                ...
                <Box className='truco_bx'>
                    <Box className="one_sec_min">
                        ...
                        <Box className='sec_contin sec_contin_v2a'>
                            ...
                            <Button className='btn_bg btn_bg_v2a'>
                    ...
                    <Container maxW='1750px' className="">
                        ...
                        <Accordion className='acod_min'>
                            <AccordionItem>
                                ...
                                <AccordionPanel pb={4}>
                                    <Text>
                                        No Brasil, jogar TrucoGold é totalmente legal. A lei brasileira permite que oscidadãos participem de jogos baseados em habilidades e estratégias, e oferecemos um ambiente de jogo que cumpre a lei. Os jogadores podem jogar no TrucoGold com confiança e encorajamos todos a jogar com responsabilidade.
                                    </Text>
                                </AccordionPanel>
                            </AccordionItem>
                            <AccordionItem>
